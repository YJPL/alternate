...
subtitle: "poor man's styleguide, a frontend styleguide for the pragmatic"
layout: article
mathjax: true
header:
    layout: hero # Choose hero or header
    vh: vh-50 vh-75-m vh-100-l  # Set a custom vertical height for mobile/tablet/desktop.
    navigation: # Choose your navigation. Options are fancy or Leave blank for white background nav.
    image: /img/sky.jpg # Set a background image.
